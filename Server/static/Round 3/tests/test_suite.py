        ...
        try:
                ...
                if output == expected:
                    print(
                        self.colored(
                            ...
                            255,
                            0,
                            f"{self.pass_emoji}  Test passed: add({case_x}, {case_y}) returned {output}",
                        )
                    )
                    ...
                    return print(
                        self.colored(
                            ...
                            0,
                            0,
                            f"{self.fail_emoji}  Test failed: add({case_x}, {case_y}) returned {output}, expected {expected}, Try again!",
                        )
                    )
            ...
            return print(
                self.colored(
                    ...
                    0,
                    0,
                    f"{self.warning_emoji}  Test Suite failed due to: {e}",
                )
            )
